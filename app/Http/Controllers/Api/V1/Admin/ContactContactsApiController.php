...
class ContactContactsApiController extends Controller
{
    public function index()
    {
        ...
        return new ContactContactResource(ContactContact::with(['company', 'status_prospect', 'assigned_to_user', 'created_by'])->get());
    }
    ...
    public function show(ContactContact $contactContact)
    {
        ...
        return new ContactContactResource($contactContact->load(['company', 'status_prospect', 'assigned_to_user', 'created_by']));
    }
