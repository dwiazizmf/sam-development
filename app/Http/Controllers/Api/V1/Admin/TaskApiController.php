...
class TaskApiController extends Controller
{
    ...
    public function index()
    {
        ...
        return new TaskResource(Task::with(['status', 'tags', 'prospect', 'customer', 'assigned_to_user', 'created_by'])->get());
    }
    ...
    public function show(Task $task)
    {
        ...
        return new TaskResource($task->load(['status', 'tags', 'prospect', 'customer', 'assigned_to_user', 'created_by']));
    }
