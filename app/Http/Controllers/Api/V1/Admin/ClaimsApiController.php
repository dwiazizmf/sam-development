...
class ClaimsApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('claim_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new ClaimResource(Claim::with(['policies', 'claim_type', 'reviewed_by_user', 'assigned_to_user', 'created_by'])->get());
    }
    ...
    public function show(Claim $claim)
    {
        ...
        return new ClaimResource($claim->load(['policies', 'claim_type', 'reviewed_by_user', 'assigned_to_user', 'created_by']));
    }
