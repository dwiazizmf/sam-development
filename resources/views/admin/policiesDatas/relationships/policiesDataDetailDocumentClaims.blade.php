    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-policiesDataDetailDocumentClaims">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.detailDocumentClaim.fields.file_upload') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($detailDocumentClaims as $key => $detailDocumentClaim)
                            <tr data-entry-id="{{ $detailDocumentClaim->id }}">
                                ...
                                <td>
                                    @if($detailDocumentClaim->file_upload)
                                        <a href="{{ $detailDocumentClaim->file_upload->getUrl() }}" target="_blank">
...
@endcan
  ...
  let table = $('.datatable-policiesDataDetailDocumentClaims:not(.ajaxTable)').DataTable({ buttons: dtButtons })
