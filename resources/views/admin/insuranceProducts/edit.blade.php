...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.insuranceProduct.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.insurance-products.update", [$insuranceProduct->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('insurance_company') ? 'is-invalid' : '' }}" name="insurance_company_id" id="insurance_company_id" required>
                    @foreach($insurance_companies as $id => $entry)
                        <option value="{{ $id }}" {{ (old('insurance_company_id') ? old('insurance_company_id') : $insuranceProduct->insurance_company->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_type') ? 'is-invalid' : '' }}" name="product_type_id" id="product_type_id" required>
                    @foreach($product_types as $id => $entry)
                        <option value="{{ $id }}" {{ (old('product_type_id') ? old('product_type_id') : $insuranceProduct->product_type->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_code') ? 'is-invalid' : '' }}" type="text" name="product_code" id="product_code" value="{{ old('product_code', $insuranceProduct->product_code) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_name') ? 'is-invalid' : '' }}" type="text" name="product_name" id="product_name" value="{{ old('product_name', $insuranceProduct->product_name) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{{ old('description', $insuranceProduct->description) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('max_claim_amount') ? 'is-invalid' : '' }}" type="number" name="max_claim_amount" id="max_claim_amount" value="{{ old('max_claim_amount', $insuranceProduct->max_claim_amount) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('commision') ? 'is-invalid' : '' }}" type="number" name="commision" id="commision" value="{{ old('commision', $insuranceProduct->commision) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policy_duration_days') ? 'is-invalid' : '' }}" type="number" name="policy_duration_days" id="policy_duration_days" value="{{ old('policy_duration_days', $insuranceProduct->policy_duration_days) }}" step="1">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('wording_product') ? 'is-invalid' : '' }}" name="wording_product" id="wording_product">{{ old('wording_product', $insuranceProduct->wording_product) }}</textarea>
