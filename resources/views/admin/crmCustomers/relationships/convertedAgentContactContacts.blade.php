    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-convertedAgentContactContacts">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.contactContact.fields.marketing') }}
                            </th>
                            <th>
                                {{ trans('cruds.contactContact.fields.priority') }}
                            </th>
                            <th>
                                {{ trans('cruds.contactContact.fields.converted_agent') }}
                            </th>
                            <th>
                                {{ trans('cruds.crmCustomer.fields.last_name') }}
                            </th>
                            <th>
                                {{ trans('cruds.contactContact.fields.conversion_date') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($contactContacts as $key => $contactContact)
                            <tr data-entry-id="{{ $contactContact->id }}">
                                ...
                                <td>
                                    {{ $contactContact->marketing->name ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\ContactContact::PRIORITY_SELECT[$contactContact->priority] ?? '' }}
                                </td>
                                <td>
                                    {{ $contactContact->converted_agent->first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $contactContact->converted_agent->last_name ?? '' }}
                                </td>
                                <td>
                                    {{ $contactContact->conversion_date ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-convertedAgentContactContacts:not(.ajaxTable)').DataTable({ buttons: dtButtons })
