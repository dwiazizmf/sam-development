    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.crm-customers.update", [$crmCustomer->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('role') ? 'is-invalid' : '' }}" name="role_id" id="role_id">
                    @foreach($roles as $id => $entry)
                        <option value="{{ $id }}" {{ (old('role_id') ? old('role_id') : $crmCustomer->role->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
                @if($errors->has('role'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_pic') ? 'is-invalid' : '' }}" type="text" name="nama_pic" id="nama_pic" value="{{ old('nama_pic', $crmCustomer->nama_pic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_telp_pic') ? 'is-invalid' : '' }}" type="text" name="no_telp_pic" id="no_telp_pic" value="{{ old('no_telp_pic', $crmCustomer->no_telp_pic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nama_bank_pic') ? 'is-invalid' : '' }}" type="text" name="nama_bank_pic" id="nama_bank_pic" value="{{ old('nama_bank_pic', $crmCustomer->nama_bank_pic) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no_rekening_pic') ? 'is-invalid' : '' }}" type="text" name="no_rekening_pic" id="no_rekening_pic" value="{{ old('no_rekening_pic', $crmCustomer->no_rekening_pic) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('assigned_to_user') ? 'is-invalid' : '' }}" name="assigned_to_user_id" id="assigned_to_user_id">
                    @foreach($assigned_to_users as $id => $entry)
                        <option value="{{ $id }}" {{ (old('assigned_to_user_id') ? old('assigned_to_user_id') : $crmCustomer->assigned_to_user->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('prospects_source') ? 'is-invalid' : '' }}" name="prospects_source_id" id="prospects_source_id">
                    @foreach($prospects_sources as $id => $entry)
                        <option value="{{ $id }}" {{ (old('prospects_source_id') ? old('prospects_source_id') : $crmCustomer->prospects_source->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control datetime {{ $errors->has('converted_date') ? 'is-invalid' : '' }}" type="text" name="converted_date" id="converted_date" value="{{ old('converted_date', $crmCustomer->converted_date) }}">
