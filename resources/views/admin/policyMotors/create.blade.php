...
<form method="POST" action="{{ route("admin.policy-motors.store") }}" enctype="multipart/form-data">
@csrf
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('aksessoris_tambahan') ? 'is-invalid' : '' }}" type="text" name="aksessoris_tambahan" id="aksessoris_tambahan" value="{{ old('aksessoris_tambahan', '') }}">
        ...
        <div class="form-group">
            ...
            <input class="form-control {{ $errors->has('aksesoris_harga') ? 'is-invalid' : '' }}" type="number" name="aksesoris_harga" id="aksesoris_harga" value="{{ old('aksesoris_harga', 0) }}" step="0.01">
...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.policyMotor.title_singular') }}
    </div>
