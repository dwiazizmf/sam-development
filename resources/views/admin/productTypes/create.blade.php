    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-types.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_type_code') ? 'is-invalid' : '' }}" type="text" name="product_type_code" id="product_type_code" value="{{ old('product_type_code', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('product_type_name') ? 'is-invalid' : '' }}" type="text" name="product_type_name" id="product_type_name" value="{{ old('product_type_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('product_type_description') ? 'is-invalid' : '' }}" name="product_type_description" id="product_type_description">{{ old('product_type_description') }}</textarea>
