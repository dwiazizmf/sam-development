    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-assignedToUserTasks">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.task.fields.prospect') }}
                            </th>
                            <th>
                                {{ trans('cruds.contactContact.fields.contact_last_name') }}
                            </th>
                            <th>
                                {{ trans('cruds.task.fields.customer') }}
                            </th>
                            <th>
                                {{ trans('cruds.task.fields.assigned_to_user') }}
                            </th>
                            <th>
                    ...
                    <tbody>
                        @foreach($tasks as $key => $task)
                            <tr data-entry-id="{{ $task->id }}">
                                ...
                                <td>
                                    {{ $task->prospect->contact_first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $task->prospect->contact_last_name ?? '' }}
                                </td>
                                <td>
                                    {{ $task->customer->name ?? '' }}
                                </td>
...
@endcan
  ...
  let table = $('.datatable-assignedToUserTasks:not(.ajaxTable)').DataTable({ buttons: dtButtons })
