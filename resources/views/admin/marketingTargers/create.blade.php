...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.marketingTarger.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.marketing-targers.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_year') ? 'is-invalid' : '' }}" type="number" name="target_year" id="target_year" value="{{ old('target_year', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('target_month') ? 'is-invalid' : '' }}" type="number" name="target_month" id="target_month" value="{{ old('target_month', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('new_prospects_target') ? 'is-invalid' : '' }}" type="number" name="new_prospects_target" id="new_prospects_target" value="{{ old('new_prospects_target', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conversion_target') ? 'is-invalid' : '' }}" type="number" name="conversion_target" id="conversion_target" value="{{ old('conversion_target', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revenue_target') ? 'is-invalid' : '' }}" type="number" name="revenue_target" id="revenue_target" value="{{ old('revenue_target', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policies_target') ? 'is-invalid' : '' }}" type="number" name="policies_target" id="policies_target" value="{{ old('policies_target', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('followup_frequency_target') ? 'is-invalid' : '' }}" type="number" name="followup_frequency_target" id="followup_frequency_target" value="{{ old('followup_frequency_target', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('new_prospects_achieved') ? 'is-invalid' : '' }}" type="number" name="new_prospects_achieved" id="new_prospects_achieved" value="{{ old('new_prospects_achieved', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conversion_achieved') ? 'is-invalid' : '' }}" type="number" name="conversion_achieved" id="conversion_achieved" value="{{ old('conversion_achieved', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('revenue_achieved') ? 'is-invalid' : '' }}" type="number" name="revenue_achieved" id="revenue_achieved" value="{{ old('revenue_achieved', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('policies_achieved') ? 'is-invalid' : '' }}" type="number" name="policies_achieved" id="policies_achieved" value="{{ old('policies_achieved', '') }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('followup_frequency_achieved') ? 'is-invalid' : '' }}" type="number" name="followup_frequency_achieved" id="followup_frequency_achieved" value="{{ old('followup_frequency_achieved', '') }}" step="1">
