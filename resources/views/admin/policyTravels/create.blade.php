...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.policyTravel.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.policy-travels.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('polis_name') ? 'is-invalid' : '' }}" type="text" name="polis_name" id="polis_name" value="{{ old('polis_name', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('policyholder_address') ? 'is-invalid' : '' }}" name="policyholder_address" id="policyholder_address" required>{{ old('policyholder_address') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('jumlah_wisatawan') ? 'is-invalid' : '' }}" type="number" name="jumlah_wisatawan" id="jumlah_wisatawan" value="{{ old('jumlah_wisatawan', '') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('asal_keberangkatan') ? 'is-invalid' : '' }}" type="text" name="asal_keberangkatan" id="asal_keberangkatan" value="{{ old('asal_keberangkatan', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tujuan_keberangkatan') ? 'is-invalid' : '' }}" type="text" name="tujuan_keberangkatan" id="tujuan_keberangkatan" value="{{ old('tujuan_keberangkatan', '') }}">
