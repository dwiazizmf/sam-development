    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-jenisRumahGedungPolicyRumahGedungs">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.policy_number') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.policy_number_external_detail') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.insurance_product') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.agent_travel') }}
                            </th>
                            <th>
                                {{ trans('cruds.crmCustomer.fields.last_name') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.policy_status') }}
                            </th>
                            <th>
                            ...
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.phone') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.nama_paket') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.policy_start_date') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.policy_end_date') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.nilai_premi') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.discount') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.net_premi') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.upload_dokumen') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.last_sync_at') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.external_policy') }}
                            </th>
                            <th>
                                {{ trans('cruds.policyRumahGedung.fields.updated_by') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($policyRumahGedungs as $key => $policyRumahGedung)
                            <tr data-entry-id="{{ $policyRumahGedung->id }}">
                                ...
                                <td>
                                    {{ $policyRumahGedung->policy_number ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->policy_number_external_detail ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->insurance_product->product_name ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->agent_travel->first_name ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->agent_travel->last_name ?? '' }}
                                </td>
                                <td>
                                    {{ App\Models\PolicyRumahGedung::POLICY_STATUS_SELECT[$policyRumahGedung->policy_status] ?? '' }}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $policyRumahGedung->phone ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->nama_paket ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->policy_start_date ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->policy_end_date ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->nilai_premi ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->discount ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->net_premi ?? '' }}
                                </td>
                                <td>
                                ...
                                <td>
                                    {{ $policyRumahGedung->last_sync_at ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->external_policy->system_name ?? '' }}
                                </td>
                                <td>
                                    {{ $policyRumahGedung->updated_by->name ?? '' }}
                                </td>
                                <td>
...
@endcan
  ...
  let table = $('.datatable-jenisRumahGedungPolicyRumahGedungs:not(.ajaxTable)').DataTable({ buttons: dtButtons })
